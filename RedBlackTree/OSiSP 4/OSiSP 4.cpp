...
#include "stdafx.h"
#include "OSiSP 4.h"
#include "../RedBlackTreeLibrary/RedBlackTreeLibrary/RedBlackTreeLibrary.h"
...
typedef void(*FINDSURNAME)(char[], HWND);
	...
	_In_ int       nCmdShow)
{
	...
	baseLoaded = false;
	DLL = LoadLibrary(L"c:\\Users\\ASUS\\Documents\\GitHub\\Drozdov\\RedBlackTree\\Debug\\RedBlackTreeLibrary.dll");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case SURNAME_BUTTON:
			...
			SetWindowText(hResultEdit, L"");
			FindSurnames(input, hResultEdit);
			break;
		case ADRESS_BUTTON:
			input = new char[30];
